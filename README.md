...
- **Aim assist** (off by default; Options or the pause menu): aiming with a stick slows right down while your aim passes over a zombie, so it's easy to settle on one, and pushing further always sweeps past. On touch this applies once you've held the aim thumb for over half a second (claw grip); a quick bump doesn't count. Otherwise, holding FIRE or KNIFE without aiming turns you to the nearest zombie you can hit. Mouse aiming is never assisted.
